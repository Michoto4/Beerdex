    ...
    return(
        <div className={styles.container}>
            ...
            <form className={styles.form} onSubmit={formik.handleSubmit}>
                ...
                <input {...formik.getFieldProps('passwordConfirm')} type="password" placeholder={t('confirmPassword')} id="passwordConfirm"></input>
                <button className={styles.registerButton} type="submit">{t('register')}</button>
                <p>{t('alreadyHave')} <a href="/">{t('login')}</a></p>
            </form>
        </div>
    )
}
